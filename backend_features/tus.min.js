!(function (e) {
  ...
  return (function n(o, i, u) {
    ...
    for (var s = 'function' == typeof require && require, e = 0; e < u.length; e++) a(u[e]);
    return a;
  })(
    {
      1: [
        function (e, t, r) {
          ...
          var o = n(e('./isReactNative.js')),
            i = n(e('./uriToBlob.js')),
            u = n(e('./sources/FileSource.js')),
            a = n(e('./sources/StreamSource.js'));
          function n(e) {
        ...
        { './isReactNative.js': 5, './sources/FileSource.js': 6, './sources/StreamSource.js': 7, './uriToBlob.js': 10 },
      ],
      2: [
        function (e, t, r) {
          'use strict';
          ...
          var n = (r = e('./isReactNative.js')) && r.__esModule ? r : { default: r };
        },
        { './isReactNative.js': 5 },
      ],
      3: [
        function (e, t, r) {
          ...
          function i(e, t, r) {
            t && o(e.prototype, t), r && o(e, r), Object.defineProperty(e, 'prototype', { writable: !1 });
          }
          Object.defineProperty(r, '__esModule', { value: !0 }), (r.default = void 0);
          r.default = (function () {
            function e() {
      ...
      4: [
        function (e, t, r) {
          ...
          Object.defineProperty(r, '__esModule', { value: !0 }),
            Object.defineProperty(r, 'DefaultHttpStack', {
              enumerable: !0,
              get: function () {
                return l.default;
              },
          ...
          var n = c(e('../upload.js')),
            i = c(e('../noopUrlStorage.js')),
            u = e('../logger.js'),
            a = c(e('../error.js')),
            s = e('./urlStorage.js'),
            l = c(e('./httpStack.js')),
            f = c(e('./fileReader.js')),
            e = c(e('./fileSignature.js'));
          function c(e) {
            return e && e.__esModule ? e : { default: e };
          }
          function p(e, t) {
          ...
          function d(r) {
            ...
            return function () {
              var e,
                t = y(r),
                t =
                  ((e = n ? ((e = y(this).constructor), Reflect.construct(t, arguments, e)) : t.apply(this, arguments)),
                  this);
          ...
          var b = v(
              ...
              {},
              {
                ...
                urlStorage: new (s.canStoreURLs ? s.WebStorageUrlStorage : i.default)(),
              ...
              (function (e) {
                ...
                function i() {
                  var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : null,
                    ...
                    r = this,
                    n = i;
                  if (r instanceof n) return (t = v(v({}, b), t)), o.call(this, e, t);
                  ...
                  (e = [
                    {
                      ...
                      value: function (e) {
                        var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
                          t = v(v({}, b), t);
                        return n.default.terminate(e, t);
                      },
                    },
                  ]),
      ...
      6: [
        function (e, t, r) {
          'use strict';
          Object.defineProperty(r, '__esModule', { value: !0 }), (r.default = void 0);
          var o = n(e('./isCordova.js')),
            i = n(e('./readAsByteArray.js'));
          function n(e) {
            return e && e.__esModule ? e : { default: e };
          }
          function u(e, t) {
              ...
              (r = [
                {
                  key: 'slice',
                  value: function (e, t) {
                    if ((0, o.default)()) return (0, i.default)(this._file.slice(e, t));
        ...
        { './isCordova.js': 8, './readAsByteArray.js': 9 },
      ],
      7: [
        function (e, t, r) {
          'use strict';
          ...
          var n = (function () {
            function t(e) {
              if (!(this instanceof t)) throw new TypeError('Cannot call a class as a function');
              (this._buffer = void 0), (this._bufferOffset = 0), (this._reader = e), (this._done = !1);
            }
            var e, r, n;
            return (
              (e = t),
              (r = [
                {
                  ...
                  value: function (e, t) {
                    return e < this._bufferOffset
                      ? Promise.reject(new Error("Requested data is before the reader's current offset"))
                ...
                },
                {
                  ...
                  value: function (r, n) {
                    ...
                    return this._done || t
                      ? ((e = null == (t = this._getDataFromBuffer(r, n)) && this._done),
                          ...
                          return (
                            e.done
                              ...
                              : (o._buffer = (function (e, t) {
                                  ...
                                  var r;
                                  if (e.set)
                                    return (r = new e.constructor(e.length + t.length)).set(e), r.set(t, e.length), r;
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    e > this._bufferOffset &&
                      ((this._buffer = this._buffer.slice(e - this._bufferOffset)), (this._bufferOffset = e));
      ...
      8: [
        function (e, t, r) {
          ...
          r.default = function () {
            return (
              'undefined' != typeof window &&
              (void 0 !== window.PhoneGap || void 0 !== window.Cordova || void 0 !== window.cordova)
            );
          };
        },
        {},
      ...
      11: [
        function (e, t, r) {
          ...
          Object.defineProperty(r, '__esModule', { value: !0 }), (r.canStoreURLs = r.WebStorageUrlStorage = void 0);
          var n = !1;
          try {
            var n = 'localStorage' in window,
              i = 'tusSupport',
              u = localStorage.getItem(i);
            localStorage.setItem(i, u), null === u && localStorage.removeItem(i);
          } catch (e) {
                ...
                (r = [
                  ...
                  },
                  {
                    ...
                    value: function (e, t) {
                      ...
                      return localStorage.setItem(e, JSON.stringify(t)), Promise.resolve(e);
                    },
                  },
                  {
                    key: '_findEntries',
      ...
      12: [
        function (e, t, r) {
          ...
          var c = (function (e) {
            ...
            function s(e) {
              ...
              if (i instanceof u)
                return (
                  ...
                  null != (i.causingError = r) && (e += ', caused by '.concat(r.toString())),
                  null != n &&
            ...
            return (
              (t = s), r && i(t.prototype, r), n && i(t, n), Object.defineProperty(t, 'prototype', { writable: !1 }), t
            );
          })(n(Error));
          r.default = c;
        },
      ...
      15: [
        function (e, t, r) {
                ...
                (r = [
                  {
                    ...
                    value: function (n) {
                      ...
                      return b(i, null, o)
                        .then(function (e) {
                          if (204 !== e.getStatus())
                            throw new u.default('tus: unexpected response while terminating upload', null, i, e);
                        })
                        .catch(function (e) {
                          if (
                            !m(
                              (e =
                                e instanceof u.default
                                  ? e
                                  : new u.default('tus: failed to terminate upload', e, i, null)),
                              0,
                              o,
                            )
                          )
                ...
                (t = [
                    ...
                    value: function () {
                      ...
                      if (r)
                        if (this.options.endpoint || this.options.uploadUrl || this.url) {
                          var e = this.options.retryDelays;
                          if (null != e && '[object Array]' !== Object.prototype.toString.call(e))
                            this._emitError(new Error('tus: the `retryDelays` option must either be an array or null'));
                          else {
                            if (1 < this.options.parallelUploads)
                              for (
                                var n = 0, o = ['uploadUrl', 'uploadSize', 'uploadLengthDeferred'];
                                n < o.length;
                                n++
                              ) {
                                var i = o[n];
                                if (this.options[i])
                                  return void this._emitError(
                                    new Error(
                                      'tus: cannot use the '.concat(i, ' option when parallelUploads is enabled'),
                                    ),
                                  );
                              }
                              ...
                              .then(function (e) {
                                return (
                                  null == e
                                    ...
                                    : (0, p.log)('Calculated fingerprint: '.concat(e)),
                                  (t._fingerprint = e),
                                  t._source || t.options.fileReader.openFile(r, t.options.chunkSize)
                                );
                              })
                              .then(function (e) {
                                if (((t._source = e), t.options.uploadLengthDeferred)) t._size = null;
                                else if (null != t.options.uploadSize) {
                                  if (((t._size = Number(t.options.uploadSize)), Number.isNaN(t._size)))
                                    return void t._emitError(
                                      new Error('tus: cannot convert `uploadSize` option into a number'),
                                    );
                                } else if (((t._size = t._source.size), null == t._size))
                                  return void t._emitError(
                                    new Error(
                                ...
                                1 < t.options.parallelUploads || null != t._parallelUploadUrls
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var r,
                        ...
                        f =
                          null != (t = this.options.parallelUploadBoundaries)
                            ? t
                            : (function (e, t) {
                                for (var r = Math.floor(e / t), n = [], o = 0; o < t; o++)
                                  n.push({ start: r * o, end: r * (o + 1) });
                                return (n[t - 1].end = e), n;
                              })(this._source.size, e),
                        t =
                          (this._parallelUploadUrls &&
                            f.forEach(function (e, t) {
                              e.uploadUrl = a._parallelUploadUrls[t] || null;
                            }),
                          (this._parallelUploadUrls = new Array(f.length)),
                          f.map(function (o, i) {
                            var u = 0;
                            return a._source.slice(o.start, o.end).then(function (e) {
                              var n = e.value;
                              return new Promise(function (e, t) {
                                var e = h(
                                    h({}, a.options),
                                    {},
                                    {
                                      ...
                                      parallelUploadBoundaries: null,
                                      metadata: {},
                                      headers: h(h({}, a.options.headers), {}, { 'Upload-Concat': 'partial' }),
                                      onSuccess: e,
                                      onError: t,
                                      onProgress: function (e) {
                                        (l = l - u + e), (u = e), a._emitProgress(l, s);
                                      },
                                      onUploadUrlAvailable: function () {
                                        (a._parallelUploadUrls[i] = r.url),
                                          a._parallelUploadUrls.filter(function (e) {
                                            return Boolean(e);
                                          }).length === f.length && a._saveUploadInUrlStorage();
                                      },
                                    },
                                  ),
                                  r = new c(n, e);
                      ...
                      Promise.all(t)
                        .then(function () {
                          (r = a._openRequest('POST', a.options.endpoint)).setHeader(
                            'Upload-Concat',
                            'final;'.concat(a._parallelUploadUrls.join(' ')),
                          );
                          var e = y(a.options.metadata);
                          return '' !== e && r.setHeader('Upload-Metadata', e), a._sendRequest(r, null);
                        })
                        .then(function (e) {
                          var t;
                          g(e.getStatus(), 200)
                            ? null == (t = e.getHeader('Location'))
                              ? a._emitHttpError(r, e, 'tus: invalid or missing Location header')
                              : ((a.url = w(a.options.endpoint, t)),
                                (0, p.log)('Created upload at '.concat(a.url)),
                                a._emitSuccess())
                            : a._emitHttpError(r, e, 'tus: unexpected response while creating upload');
                        })
                        .catch(function (e) {
                          a._emitError(e);
                        });
                  ...
                  },
                  {
                    ...
                    value: function () {
                      (this._aborted = !1),
                        null != this.url
                          ? ((0, p.log)('Resuming upload from previous URL: '.concat(this.url)), this._resumeUpload())
                          : null != this.options.uploadUrl
                          ? ((0, p.log)('Resuming upload from provided URL: '.concat(this.options.uploadUrl)),
                            (this.url = this.options.uploadUrl),
                            this._resumeUpload())
                          : ((0, p.log)('Creating a new upload'), this._createUpload());
                    },
                  },
                  {
                    key: 'abort',
                    value: function (t) {
                      ...
                      return (
                        ...
                        t && null != this.url
                          ? c.terminate(this.url, this.options).then(function () {
                    ...
                    value: function (e) {
                      ...
                      if (!this._aborted) {
                        if (null != this.options.retryDelays)
                          if (
                            (null != this._offset && this._offset > this._offsetBeforeRetry && (this._retryAttempt = 0),
                            m(e, this._retryAttempt, this.options))
                          )
                            return (
                              (t = this.options.retryDelays[this._retryAttempt++]),
                              (this._offsetBeforeRetry = this._offset),
                              void (this._retryTimeout = setTimeout(function () {
                                r.start();
                              }, t))
                            );
                  ...
                  },
                  {
                    key: '_emitSuccess',
                    value: function () {
                      this.options.removeFingerprintOnSuccess && this._removeFromUrlStorage(),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      this.options.endpoint
                        ? ((r = this._openRequest('POST', this.options.endpoint)),
                          this.options.uploadLengthDeferred
                            ? r.setHeader('Upload-Defer-Length', 1)
                            : r.setHeader('Upload-Length', this._size),
                          '' !== (e = y(this.options.metadata)) && r.setHeader('Upload-Metadata', e),
                          (this.options.uploadDataDuringCreation && !this.options.uploadLengthDeferred
                            ...
                            .then(function (e) {
                              ...
                              g(e.getStatus(), 200)
                                ? null == (t = e.getHeader('Location'))
                                  ? n._emitHttpError(r, e, 'tus: invalid or missing Location header')
                                  : ((n.url = w(n.options.endpoint, t)),
                                    (0, p.log)('Created upload at '.concat(n.url)),
                                    'function' == typeof n.options.onUploadUrlAvailable &&
                                ...
                                : n._emitHttpError(r, e, 'tus: unexpected response while creating upload');
                            })
                            .catch(function (e) {
                              n._emitHttpError(r, null, 'tus: failed to create upload', e);
                            }))
                    ...
                    value: function () {
                      ...
                      this._sendRequest(i, null)
                        .then(function (e) {
                          ...
                          if (!g(t, 200))
                            return 423 === t
                              ? void o._emitHttpError(i, e, 'tus: upload is currently locked; retry later')
                              : (g(t, 400) && o._removeFromUrlStorage(),
                                o.options.endpoint
                                  ? ((o.url = null), void o._createUpload())
                                  : void o._emitHttpError(
                                      i,
                                      e,
                                      'tus: unable to resume upload (new upload cannot be created without an endpoint)',
                                    ));
                          var r,
                            n = parseInt(e.getHeader('Upload-Offset'), 10);
                          Number.isNaN(n)
                            ? o._emitHttpError(i, e, 'tus: invalid or missing offset value')
                            : ((r = parseInt(e.getHeader('Upload-Length'), 10)),
                              Number.isNaN(r) && !o.options.uploadLengthDeferred
                                ? o._emitHttpError(i, e, 'tus: invalid or missing length value')
                                : ('function' == typeof o.options.onUploadUrlAvailable &&
                                    o.options.onUploadUrlAvailable(),
                                  o._saveUploadInUrlStorage().then(function () {
                                    n === r
                                      ? (o._emitProgress(r, r), o._emitSuccess())
                                      : ((o._offset = n), o._performUpload());
                                  })));
                        })
                        .catch(function (e) {
                          o._emitHttpError(i, null, 'tus: failed to resume upload', e);
                        });
                    },
                  },
                  {
                    ...
                    value: function () {
                      ...
                      this._aborted ||
                        (this.options.overridePatchMethod
                          ? (t = this._openRequest('POST', this.url)).setHeader('X-HTTP-Method-Override', 'PATCH')
                        ...
                        this._addChunkToRequest(t)
                          .then(function (e) {
                            g(e.getStatus(), 200)
                              ...
                              : r._emitHttpError(t, e, 'tus: unexpected response while uploading chunk');
                          })
                          .catch(function (e) {
                            r._aborted ||
                              r._emitHttpError(t, null, 'tus: failed to upload chunk at offset '.concat(r._offset), e);
                          }));
                    },
                  },
                  {
                    ...
                    value: function (r) {
                      ...
                      return (
                        ...
                        r.setHeader('Content-Type', 'application/offset+octet-stream'),
                        ...
                        this._source.slice(t, e).then(function (e) {
                          ...
                          return (
                            n.options.uploadLengthDeferred &&
                              e &&
                              ((n._size = n._offset + (t && t.size ? t.size : 0)),
                              r.setHeader('Upload-Length', n._size)),
                            null === t ? n._sendRequest(r) : (n._emitProgress(n._offset, n._size), n._sendRequest(r, t))
                          );
                        })
                      );
                    },
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var t = this;
                      this._urlStorageKey &&
                        (this._urlStorage.removeUpload(this._urlStorageKey).catch(function (e) {
                          t._emitError(e);
                        }),
                        (this._urlStorageKey = null));
                    },
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return (
                        ...
                        this._urlStorage.addUpload(this._fingerprint, e).then(function (e) {
                          t._urlStorageKey = e;
                        })
                      );
                    },
                  },
                  {
                    key: '_sendRequest',
                    value: function (e) {
                      return b(e, 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : null, this.options);
                    },
                  },
                ]) && d(e.prototype, t),
                r && d(e, r),
            ...
            return Object.entries(e)
              .map(function (e) {
                var e = s(e, 2),
                  t = e[0],
                  e = e[1];
                return ''.concat(t, ' ').concat(n.Base64.encode(String(e)));
              })
              .join(',');
          }
          function g(e, t) {
          ...
          function v(e, t, r) {
            var n = r.httpStack.createRequest(e, t),
              e = (n.setHeader('Tus-Resumable', '1.0.0'), r.headers || {});
            return (
              ...
              r.addRequestId && ((t = (0, i.default)()), n.setHeader('X-Request-ID', t)),
              n
            );
          }
          function b(t, e, r) {
            return (
              'function' == typeof r.onBeforeRequest ? Promise.resolve(r.onBeforeRequest(t)) : Promise.resolve()
            ).then(function () {
              return t.send(e).then(function (e) {
                return (
                  'function' == typeof r.onAfterResponse ? Promise.resolve(r.onAfterResponse(t, e)) : Promise.resolve()
                ).then(function () {
                  return e;
                });
              });
          ...
          function m(e, t, r) {
            if (!(null == r.retryDelays || t >= r.retryDelays.length || null == e.originalRequest)) {
              if (r && 'function' == typeof r.onShouldRetry) return r.onShouldRetry(e, t, r);
              t = e.originalResponse ? e.originalResponse.getStatus() : 0;
              return (
                (!g(t, 400) || 409 === t || 423 === t) &&
                ((r = !0),
                (r = !('undefined' != typeof window && 'navigator' in window && !1 === window.navigator.onLine) && r))
              );
            }
          }
          function w(e, t) {
        ...
        { './error.js': 12, './logger.js': 13, './uuid.js': 16, 'js-base64': 20, 'url-parse': 23 },
      ],
      16: [
        function (e, t, r) {
          'use strict';
        ...
        function (e, t, r) {
          ...
          (r.byteLength = function (e) {
            ...
            (r.toByteArray = function (e) {
              ...
              for (r = 0; r < a; r += 4)
                (t =
                  ...
                  (i[u++] = (t >> 8) & 255),
                  (i[u++] = 255 & t);
              2 === n && ((t = (s[e.charCodeAt(r)] << 2) | (s[e.charCodeAt(r + 1)] >> 4)), (i[u++] = 255 & t));
              1 === n &&
            ...
            (r.fromByteArray = function (e) {
              for (var t, r = e.length, n = r % 3, o = [], i = 0, u = r - n; i < u; i += 16383)
                o.push(
                  (function (e, t, r) {
              ...
              1 == n
                ...
                : 2 == n &&
                  ((t = (e[r - 2] << 8) + e[r - 1]), o.push(a[t >> 10] + a[(t >> 4) & 63] + a[(t << 2) & 63] + '='));
              return o.join('');
            });
          for (
            var a = [],
            ...
            !function () {
              ...
              function n(e, t, r) {
                if ('string' == typeof e) {
                  var n = e,
                    o = t;
                  if (!c.isEncoding((o = 'string' == typeof o && '' !== o ? o : 'utf8')))
                ...
                if (P(e, ArrayBuffer) || (e && P(e.buffer, ArrayBuffer))) {
                  ...
                  if (o.byteLength < i + (n || 0)) throw new RangeError('"length" is outside of buffer bounds');
                  return (
                    ((o =
                      void 0 === i && void 0 === n
                        ? new Uint8Array(o)
                ...
                var a = (function (e) {
                  {
                    var t, r;
                    if (c.isBuffer(e)) return (t = 0 | f(e.length)), 0 !== (r = s(t)).length && e.copy(r, 0, 0, t), r;
                  }
                  if (void 0 !== e.length) return 'number' != typeof e.length || x(e.length) ? s(0) : l(e);
              ...
              function f(e) {
                if (t <= e)
                  throw new RangeError(
                    'Attempt to allocate Buffer larger than maximum size: 0x' + t.toString(16) + ' bytes',
                  );
                return 0 | e;
              }
              function p(e, t) {
                ...
                for (e = e || 'utf8'; ; )
                  switch (e) {
                    ...
                    case 'ascii':
                      ...
                      for (var d = s; d < p; ++d) h += String.fromCharCode(127 & c[d]);
                      return h;
                    case 'latin1':
                    case 'binary':
                      var y = this,
                      ...
                      for (var b = u; b < g; ++b) v += String.fromCharCode(y[b]);
                      return v;
                    case 'base64':
                      return (
                        (m = this),
                        (n = r),
                        0 === (w = t) && n === m.length ? E.fromByteArray(m) : E.fromByteArray(m.slice(w, n))
                      );
                    case 'ucs2':
                    case 'ucs-2':
                    case 'utf16le':
                    case 'utf-16le':
                      for (var m = t, w = r, _ = this.slice(m, w), U = '', S = 0; S < _.length; S += 2)
                        U += String.fromCharCode(_[S] + 256 * _[S + 1]);
                      return U;
                    default:
              ...
              function h(e, t, r, n, o) {
                ...
                if (
                  ...
                  (r = (r = x((r = +r)) ? (o ? 0 : e.length - 1) : r) < 0 ? e.length + r : r) >= e.length)
                ) {
                  if (o) return -1;
                  r = e.length - 1;
                } else if (r < 0) {
                ...
                return R(
                  (function (e, t) {
                    for (var r, n, o = [], i = 0; i < e.length && !((t -= 2) < 0); ++i)
                      (n = e.charCodeAt(i)), (r = n >> 8), (n = n % 256), o.push(n), o.push(r);
                    return o;
                  })(t, e.length - r),
                  e,
                  r,
              ...
              function O(e, t, r) {
                  ...
                  if (o + c <= r)
                    switch (c) {
                      case 1:
                        ...
                        break;
                      case 2:
                        128 == (192 & (i = e[o + 1])) && 127 < (s = ((31 & l) << 6) | (63 & i)) && (f = s);
                        break;
                      case 3:
                        (i = e[o + 1]),
                          (u = e[o + 2]),
                      ...
                      case 4:
                        (i = e[o + 1]),
                          ...
                          128 == (192 & i) &&
                            128 == (192 & u) &&
                            128 == (192 & a) &&
                            65535 < (s = ((15 & l) << 18) | ((63 & i) << 12) | ((63 & u) << 6) | (63 & a)) &&
                            s < 1114112 &&
                            (f = s);
                    }
                  null === f
                    ? ((f = 65533), (c = 1))
                    : 65535 < f && ((f -= 65536), n.push(((f >>> 10) & 1023) | 55296), (f = 56320 | (1023 & f))),
                    n.push(f),
                    (o += c);
                }
                var p = n,
                ...
                for (var d = '', y = 0; y < h; ) d += String.fromCharCode.apply(String, p.slice(y, (y += b)));
                return d;
              }
              (C.kMaxLength = t),
                ...
                (c.alloc = function (e, t, r) {
                  return (
                    ...
                    (r = r),
                    o((e = e)),
                    !(e <= 0) && void 0 !== t ? ('string' == typeof r ? s(e).fill(t, r) : s(e).fill(t)) : s(e)
                  );
                }),
                (c.allocUnsafe = u),
                (c.allocUnsafeSlow = u),
                ...
                (c.compare = function (e, t) {
                  if (
                    (P(e, Uint8Array) && (e = c.from(e, e.offset, e.byteLength)),
                    P(t, Uint8Array) && (t = c.from(t, t.offset, t.byteLength)),
                ...
                (c.concat = function (e, t) {
                  ...
                  for (var r = c.allocUnsafe(t), n = 0, o = 0; o < e.length; ++o) {
                    var i = e[o];
                    if ((P(i, Uint8Array) && (i = c.from(i)), !c.isBuffer(i)))
                ...
                (c.prototype.toLocaleString = c.prototype.toString =
                  function () {
                    var e = this.length;
                    return 0 === e ? '' : 0 === arguments.length ? O(this, 0, e) : r.apply(this, arguments);
                  }),
                (c.prototype.equals = function (e) {
                  if (c.isBuffer(e)) return this === e || 0 === c.compare(this, e);
                  throw new TypeError('Argument must be a Buffer');
                }),
                (c.prototype.inspect = function () {
                  var e = '',
                    t = C.INSPECT_MAX_BYTES,
                ...
                (c.prototype.compare = function (e, t, r, n, o) {
                  if ((P(e, Uint8Array) && (e = c.from(e, e.offset, e.byteLength)), !c.isBuffer(e)))
                    throw new TypeError(
                ...
                (c.prototype.write = function (e, t, r, n) {
                  ...
                  for (var i, u, a, s = !1; ; )
                    switch (n) {
                      ...
                      case 'utf8':
                      case 'utf-8':
                        return (h = t), (a = r), R(j(e, (u = this).length - h), u, h, a);
                      case 'ascii':
                        return g(this, e, t, r);
                      case 'latin1':
                      case 'binary':
                        return g(this, e, t, r);
                      case 'base64':
                        return (u = this), (a = t), (i = r), R(A(e), u, a, i);
                      case 'ucs2':
                      case 'ucs-2':
                      case 'utf16le':
                      case 'utf-16le':
              ...
              function _(e, t, r, n, o) {
                return (t = +t), (r >>>= 0), o || w(e, 0, r, 4), i.write(e, t, r, n, 23, 4), r + 4;
              }
              function U(e, t, r, n, o) {
                return (t = +t), (r >>>= 0), o || w(e, 0, r, 8), i.write(e, t, r, n, 52, 8), r + 8;
              }
              (c.prototype.slice = function (e, t) {
                ...
                (c.prototype.writeIntLE = function (e, t, r, n) {
                  (e = +e), (t >>>= 0), n || m(this, e, t, r, (n = Math.pow(2, 8 * r - 1)) - 1, -n);
                  var o = 0,
                    i = 1,
                    u = 0;
                  for (this[t] = 255 & e; ++o < r && (i *= 256); )
                    e < 0 && 0 === u && 0 !== this[t + o - 1] && (u = 1), (this[t + o] = (((e / i) >> 0) - u) & 255);
                  return t + r;
                }),
        ...
        function (e, t, r) {
          (r.read = function (e, t, r, n, o) {
            var i,
              ...
              p = r ? -1 : 1,
              o = e[t + c];
            for (c += p, i = o & ((1 << -f) - 1), o >>= -f, f += a; 0 < f; i = 256 * i + e[t + c], c += p, f -= 8);
            for (u = i & ((1 << -f) - 1), i >>= -f, f += n; 0 < f; u = 256 * u + e[t + c], c += p, f -= 8);
            if (0 === i) i = 1 - l;
            else {
                ...
                t = Math.abs(t),
                  isNaN(t) || t === 1 / 0
                    ...
                    : ((u = Math.floor(Math.log(t) / Math.LN2)),
                      ...
                      2 <= (t += 1 <= u + f ? c / n : c * Math.pow(2, 1 - f)) * n && (u++, (n /= 2)),
                      l <= u + f
                        ? ((a = 0), (u = l))
                        : 1 <= u + f
                        ? ((a = (t * n - 1) * Math.pow(2, o)), (u += f))
                        : ((a = t * Math.pow(2, f - 1) * Math.pow(2, o)), (u = 0)));
                8 <= o;
                e[r + p] = 255 & a, p += h, a /= 256, o -= 8
              );
              for (u = (u << o) | a, s += o; 0 < s; e[r + p] = 255 & u, p += h, u /= 256, s -= 8);
              e[r + p - h] |= 128 * i;
            });
        },
        {},
      ...
      20: [
        function (e, i, u) {
          !function (o, D) {
            !function () {
              var e, t, r, n;
              (e = 'undefined' != typeof self ? self : 'undefined' != typeof window ? window : void 0 !== o ? o : this),
                (t = function () {
                  'use strict';
                  function r(e) {
                  ...
                  function e(e) {
                    for (var t, r, n, o = '', i = e.length % 3, u = 0; u < e.length; ) {
                      if (
                  ...
                  function t(e, t) {
                    return (t = void 0 === t ? !1 : t) ? r(P(e)) : P(e);
                  }
                  function n(e) {
                    var t;
                    return e.length < 2
                  ...
                  function i(e, t) {
                    return (t = void 0 === t ? !1 : t) ? r(B(e)) : B(e);
                  }
                  function u(e) {
                    return i(e, !0);
                  }
                  ...
                  function l(e) {
                    if (((e = e.replace(/\s+/g, '')), !E.test(e))) throw new TypeError('malformed base64.');
                  ...
                  var g,
                    ...
                    m = 'function' == typeof D,
                    w = 'function' == typeof TextDecoder ? new TextDecoder() : void 0,
                    _ = 'function' == typeof TextEncoder ? new TextEncoder() : void 0,
                    ...
                    C = /[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,
                    k = v
                      ? function (e) {
                          return atob(A(e));
                        }
                    ...
                    T = m
                      ? function (e) {
                          return j(D.from(e, 'base64'));
                        }
                      : function (e) {
                          return j(k(e), function (e) {
        ...
        function (e, r, t) {
          !function (u) {
            !function () {
              ...
              function b(e) {
                var t,
                  r = 'undefined' != typeof window ? window : void 0 !== u ? u : 'undefined' != typeof self ? self : {},
                  r = r.location || {},
                  n = {},
                  r = typeof (e = e || r);
                if ('blob:' === e.protocol) n = new _(unescape(e.pathname), {});
                else if ('string' == r) for (t in ((n = new _(e, {})), i)) delete n[t];
                else if ('object' == r) {
              ...
              function w(e, t) {
                ...
                return (
                  o
                    ? (u = i ? ((r = e[2] + e[3] + e[4]), e[2].length + e[3].length) : ((r = e[2] + e[4]), e[2].length))
                    : i
              ...
              function _(e, t, r) {
                if (((e = (e = g(e)).replace(d, '')), !(this instanceof _))) return new _(e, t, r);
                var n,
                  o,
                  i,
                  u,
                ...
                for (
                  'object' != l && 'string' != l && ((r = t), (t = null)),
                    ...
                    e = l.rest,
                    (('file:' === l.protocol && (2 !== l.slashesCount || y.test(e))) ||
                      (!l.slashes && (l.protocol || l.slashesCount < 2 || !m(f.protocol)))) &&
                      (s[3] = [/(.*)/, 'pathname']);
                  c < s.length;
                  c++
                )
                  'function' == typeof (i = s[c])
                    ...
                    : ((o = i[0]),
                      ...
                      o != o
                        ...
                        : (u = o.exec(e)) && ((f[a] = u[1]), (e = e.slice(0, u.index))),
                      (f[a] = f[a] || (n && i[3] && t[a]) || ''),
                ...
                r && (f.query = r(f.query)),
                  ...
                  '/' !== f.pathname.charAt(0) && m(f.protocol) && (f.pathname = '/' + f.pathname),
                  ...
                  (f.origin = 'file:' !== f.protocol && m(f.protocol) && f.host ? f.protocol + '//' + f.host : 'null'),
                  (f.href = f.toString());
              }
              (_.prototype = {
                set: function (e, t, r) {
                  ...
                  switch (e) {
                    ...
                    case 'port':
                      (n[e] = t),
                        p(t, n.protocol) ? t && (n.host = n.hostname + ':' + t) : ((n.host = n.hostname), (n[e] = ''));
                      break;
                    case 'hostname':
                  ...
                  return (
                    ...
                    (n.origin =
                      'file:' !== n.protocol && m(n.protocol) && n.host ? n.protocol + '//' + n.host : 'null'),
                    (n.href = n.toString()),
                    n
                  );
                },
                toString: function (e) {
                  ...
                  var t = this,
                    ...
                    n =
                      ...
                      n + ((t.protocol && t.slashes) || m(t.protocol) ? '//' : ''));
                  return (
                    t.username
                      ? ((n += t.username), t.password && (n += ':' + t.password), (n += '@'))
                      : t.password
                      ? (n = n + (':' + t.password) + '@')
                      : 'file:' !== t.protocol && m(t.protocol) && !r && '/' !== t.pathname && (n += '@'),
                    (':' === r[r.length - 1] || (a.test(t.hostname) && !t.port)) && (r += ':'),
                    (n += r + t.pathname),
